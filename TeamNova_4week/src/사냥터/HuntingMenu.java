...
public class HuntingMenu {
    ...
    public int MageMenu(MageClass mage){
        ...
        System.out.printf("3) %s <데미지 : %d> \n", mage.HaveSkillList.get(1).SkillName,iTemp + mage.MagicAttack);
        iTemp = mage.HaveSkillList.get(2).Add_MagicAttack;
        System.out.printf("4) %s <데미지 : %d> \n", mage.HaveSkillList.get(2).SkillName,iTemp + mage.MagicAttack);
