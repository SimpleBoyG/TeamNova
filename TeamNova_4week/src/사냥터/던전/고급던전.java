...
public class 고급던전 extends 고급사냥터 {
    ...
    Monster 거대엔트 = new Monster("거대 엔트",31,50,20,360,20,20);
    Monster 스켈레톤전사 = new Monster("스켈레톤 전사",32,50,20,500,30,30);
    Monster 리자드맨전사 = new Monster("리자드맨 전사",33,60,30,380,20,25);
